...
class Settings(BaseSettings):
    ...
    db_path: Path = Field(default_factory=lambda: project_root() / "all_talks.db", alias="ALL_TALKS_DB")
    ...
    model_svr_path: Path = Field(default_factory=lambda: project_root() / "svr.sav", alias="SVR_MODEL_PATH")
